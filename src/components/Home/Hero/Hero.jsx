    ...
    <div className="h-[768px] xl:h-[890px] relative">
      ...
      >
        <div className="flex flex-col justify-center items-center">
          <h2 className="text-[48px] leading-[55px] md:text-[60px] md:leading-[69px] lg:text-[74px] lg:leading-[84px] tracking-wide font-bold capitalize text-center max-w-[17ch]">
